...
- **1 venda da Skale com telefone do RS sem DDI (`ven_136041`)**: correção autorizada pelo usuário em 16/09/2026, **aguardando o usuário aplicar pelo painel** (ele não tem acesso direto ao banco) com a rota `POST /api/dashboard/vendas-skale/ven_136041/corrigir-telefone` (ver Funcionalidades). O telefone original dela na Skale já vem com DDI (13 dígitos).
